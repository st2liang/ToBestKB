...
from ToBestKB.controller import FileController
...
urlpatterns = [
    ...
    path("kdb/", KBController.KB_file_show),
    ...
    path("conversation/ask/",ConversationController.conversation_content),

    path("kdb/upload/", FileController.file_upload),
    path("kdb/delete_file/", FileController.file_delete)
